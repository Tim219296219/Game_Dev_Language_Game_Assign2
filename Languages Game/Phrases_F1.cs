...
{
    public partial class FrmPhrases_F1 : Form
    {
        System.Media.SoundPlayer player = new System.Media.SoundPlayer();
        public FrmPhrases_F1()
        {
            InitializeComponent();
        }
        ...
        {
            btnBonjour.DoDragDrop(btnBonjour.Text, DragDropEffects.Copy | DragDropEffects.Move);
        }
        ...
        {
            btnAurevoir.DoDragDrop(btnAurevoir.Text, DragDropEffects.Copy | DragDropEffects.Move);
        }
        ...
        {
            btnCommentallezvous.DoDragDrop(btnCommentallezvous.Text, DragDropEffects.Copy | DragDropEffects.Move);
        }
        ...
        {
            btnBonsoir.DoDragDrop(btnBonsoir.Text, DragDropEffects.Copy | DragDropEffects.Move);
        }
        ...
        {
            if (txtBox3.Text == "Comment allez-vous")
